...
export function Hero() {
      ...
      >
        <div className="relative z-20 text-center max-w-6xl mx-auto px-6">
          ...
          <p className="text-xl md:text-2xl text-white/80 mb-12 max-w-3xl mx-auto leading-relaxed">
            Discover premium residential, commercial & investment properties
            across Mumbai, Delhi, Bangalore & more
          </p>
        </div>
      </section>
    );
  ...
  return (
    <section
      id="home"
      className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-navy via-navy-light to-teal"
    >
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    <option value="mumbai" className="bg-navy">
                      Mumbai
                    </option>
                    <option value="delhi" className="bg-navy">
                      Delhi NCR
                    </option>
                    <option value="bangalore" className="bg-navy">
                      Bangalore
                    </option>
                    <option value="pune" className="bg-navy">
                      Pune
                    </option>
                    <option value="hyderabad" className="bg-navy">
                      Hyderabad
                    </option>
                    <option value="chennai" className="bg-navy">
                      Chennai
                    </option>
                  </select>
                </div>
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  ...
                  <select
                    ...
                    className="bg-transparent text-white text-sm focus:outline-none w-full"
                  >
                    <option value="residential" className="bg-navy">
                      Residential
                    </option>
                    <option value="commercial" className="bg-navy">
                      Commercial
                    </option>
                    <option value="plots" className="bg-navy">
                      Plots/Land
                    </option>
                    <option value="investment" className="bg-navy">
                      Investment
                    </option>
                  </select>
                </div>
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-white/5 rounded-2xl">
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    <option value="100-250" className="bg-navy">
                      ₹1Cr - ₹2.5Cr
                    </option>
                    <option value="250-500" className="bg-navy">
                      ₹2.5Cr - ₹5Cr
                    </option>
                    <option value="500+" className="bg-navy">
                      ₹5Cr+
                    </option>
                  </select>
                </div>
